 ...
 * $Id: bb7d72c53371af1d3a675219211142e594ad77da $
 *
...
//  msg_Warn(vout, "%s",current_timeOK);
  ...
  sprintf(directory,"%s","/sdcard/vlcplayer/vlc_frames");
...
static int ThreadDisplayPreparePicture(vout_thread_t *vout, bool reuse, bool frame_by_frame)
{
    ...
    char who[20]="DisplayPicture"; //BTH patch
    LogIT(vout,who); //BTH patch
