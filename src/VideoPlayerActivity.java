...
public class VideoPlayerActivity extends AppCompatActivity implements IVLCVout.Callback,
	...
	//BTH patch
	//create /sdcard/vlcplayer directory
	...
	writeToFile("vlc_nettype",simOperatorName+","+networkType+","+dataState+","+getClock()+"\n");
	...
	writeToFile("vlc_screen","");
        writeToFile("vlc_application","Media_Launched"+","+getClock()+"\n");
	LogPackets();
	//BTH patch ends
	...
	long currentMobileTXBytes = TrafficStats.getMobileTxBytes();
        long currentMobileRXPackets = TrafficStats.getMobileRxPackets();
        long currentMobileTXPackets = TrafficStats.getMobileTxPackets();

	myPacketHandler.postDelayed(myPacketRunnable,1000);
   	writeToFile("vlc_packets",
	currentRXBytes+","+currentTXBytes+","+
	currentRXPackets+","+currentTXPackets+","+
	currentMobileRXBytes+","+currentMobileTXBytes+","+
	currentMobileRXPackets+","+currentMobileTXPackets+","+
	getClock()+"\n");
	}
    };
    //BTH patch ends here
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        case KeyEvent.KEYCODE_MEDIA_FAST_FORWARD:
            seekDelta(10000);
            writeToFile("vlc_application","Media_Fast_Forward,"+getClock()+"\n");
            return true;
        case KeyEvent.KEYCODE_R:
        case KeyEvent.KEYCODE_MEDIA_REWIND:
            seekDelta(-10000);
            writeToFile("vlc_application","Media_Rewind,"+getClock()+"\n");
            return true;
	    ...
	    writeToFile("vlc_application","Media_Play_Pause,"+getClock()+"\n");
        case KeyEvent.KEYCODE_MEDIA_PLAY:
	    writeToFile("vlc_application","Media_Play,"+getClock()+"\n");
        case KeyEvent.KEYCODE_MEDIA_PAUSE:
	    writeToFile("vlc_application","Media_Pause,"+getClock()+"\n");
