 ...
 * $Id: 118612c95f6ba7f853f653affd3be485f33ae499 $
 *
...
void LogITInput(char *whateverInput){
  ...
  sprintf(directoryInput,"%s","/sdcard/vlcplayer/vlc_source");
                               ...
                               input_resource_t *p_resource )
{
    ...
    char* videoSourceName=psz_name;//BTH patch
    LogITInput(videoSourceName);//BTH patch
